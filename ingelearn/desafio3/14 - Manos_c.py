# esto lo que hace es controlar el plc en base con nuestros dedos si levantamos 
# los cuatro dedos se encenderan las cuatro luces dentro del plc

import cv2
import cv2.text
import mediapipe as mp
from math import dist
# le añadimos esta libreria para trabajar con plc
from pymodbus.client import ModbusTcpClient
import time

#aqui hay que colocar la direccion IP de el PLC al que queremos conectarnos
...
while True:
    ...
    #print deteccion nos mostrara por terminal como guarda cuando levantamos los dedos o no 
    #estos mismos seran con 0 y 1
    #print(deteccion)
